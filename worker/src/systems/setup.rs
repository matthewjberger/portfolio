...
/// Builds the whole portfolio world once: render settings, lighting, and the
/// section vignettes the camera tour flies between.
...
/// A floating platform with an emissive trim, shared by the hero island and
/// the highlight shrine.
